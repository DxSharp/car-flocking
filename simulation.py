...
for i in range(CAR_COUNT):
    ...
    new_car = Car(CAR_LENGTH, CAR_WIDTH, CAR_WHEELBASE, CAR_MAX_VELOCITY, CAR_MAX_ACCELERATION,
                  ...
                  acceleration=0, steering_angle=random_angle, angle=random_angle * 5.0, velocity=20)
...
if DEBUG:
    ...
    while running:
        ...
        if event.type == pygame.QUIT:
            ...
            world.update(1.0 / STEPS_PER_SECOND, NEIGHBOR_COUNT)
    ...
    while running:
        ...
        world.update(dt, NEIGHBOR_COUNT)
